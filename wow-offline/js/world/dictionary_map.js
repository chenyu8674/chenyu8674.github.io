...
function new_map() {
    ...
    map["丹莫罗"] = {
        ...
        x: 754, y: 630, start_x: 23, end_x: 86, start_y: 34, end_y: 66,
    ...
    map["艾尔文森林"] = {
        detail: "", type: 1, min: 1, max: 10,
        x: 778, y: 752, start_x: 27, end_x: 86, start_y: 40, end_y: 87,
        monster: ["兔子", "鹿",
    ...
    map["泰达希尔"] = {
        detail: "", type: 1, min: 1, max: 10,
        x: 147, y: 267, start_x: 36, end_x: 67, start_y: 28, end_y: 77,
        monster: ["蟾蜍", "鹿",
    ...
    map["杜隆塔尔"] = {
        detail: "", type: 1, min: 1, max: 10,
        x: 274, y: 563, start_x: 35, end_x: 60, start_y: 12, end_y: 80,
        monster: ["野兔", "蝰蛇",
    ...
    map["莫高雷"] = {
        detail: "", type: 1, min: 1, max: 10,
        x: 183, y: 652, start_x: 31, end_x: 65, start_y: 9, end_y: 89,
        monster: ["草原土拨鼠", "平原陆行鸟",
    ...
    map["提瑞斯法林地"] = {
        detail: "", type: 1, min: 1, max: 10,
        x: 750, y: 394, start_x: 36, end_x: 86, start_y: 36, end_y: 74,
        monster: ["食腐狼幼崽", "无脑的僵尸",
    ...
    map["西部荒野"] = {
        detail: "《暴风城的粮仓》", type: 1, min: 10, max: 20,
        x: 738, y: 793, start_x: 29, end_x: 65, start_y: 15, end_y: 82,
        monster: ["生锈的麦田魔像", "看守傀儡", "收割傀儡",
            "小碎尸鸟", "碎尸鸟", "大碎尸鸟", "河爪豺狼人",
            "河爪斥候", "河爪秘法师",
            "迪菲亚走私者", "迪菲亚巡路者", "迪菲亚袭击者"],
    ...
    map["怒焰裂谷"] = {
        ...
        x: 280, y: 520, start_x: 61, start_y: 7,
        monster: [
            {x: 685, y: 105},
    ...
    map["死亡矿井"] = {
        ...
        x: 735, y: 825, start_x: 298, start_y: 133,
