...
function new_map() {
    ...
    map["怒焰裂谷"] = {
        ...
        monster: [
            {x: 68.5, y: 10.5},
            {name: "强壮的烈焰猎犬", lvl: 7, x: 66.8, y: 15.2},
            {name: "成年的烈焰猎犬", lvl: 7, x: 66, y: 27},
            {name: "成年的烈焰猎犬", lvl: 7, x: 65.6, y: 43},
            {name: "堕落的驯犬人", lvl: 7, x: 66.2, y: 60},
            {name: "阿达罗格", lvl: 8, x: 70, y: 65},

            {name: "黑暗萨满助手", lvl: 7, x: 64, y: 70},
            {name: "黑暗萨满助手", lvl: 7, x: 59.8, y: 65.2},
            {name: "黑暗萨满研究者", lvl: 7, x: 60, y: 50},
            {x: 60, y: 34},
            {name: "黑暗萨满研究者", lvl: 7, x: 59, y: 32},
            {name: "黑暗萨满柯兰萨", lvl: 8, x: 54.5, y: 28.2},

            {name:"熔岩元素",lvl:8,x:52,y:37},
            {name:"怒焰穴居人",lvl:8,x:50,y:49},
            {name:"怒焰萨满祭司",lvl:8,x:48.3,y:62.3},
            {name:"焰喉",lvl:9,x:40.8,y:58},

            {name:"燃刃术士",lvl:9,x:33.3,y:55},
            {name:"燃刃信徒",lvl:9,x:32.5,y:67},
            {name:"燃刃执行者",lvl:9,x:31.6,y:76},
            {name:"熔岩守卫戈多斯",lvl:10,x:34.3,y:82.2}
        ]
    }
    /*
        map["赤脊山"] = {
