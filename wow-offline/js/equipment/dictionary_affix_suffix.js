...
function new_affix_suffix() {
    ...
    affix["守护"] = function (lvl, rare, multiple) {return ["block_rate+=" + get_effect_value(1, lvl, rare, multiple), "block_value+=" + get_effect_value(0.5, lvl, rare, multiple)]}
    ...
    affix["坚固"] = function (lvl, rare, multiple) {return ["res_physical+=" + get_effect_value(0.08, lvl, rare, multiple)]}
    affix["灼热"] = function (lvl, rare, multiple) {return ["damage_fire+=" + get_effect_value(0.08, lvl, rare, multiple)]}
    ...
    affix["冰冷"] = function (lvl, rare, multiple) {return ["damage_frost+=" + get_effect_value(0.08, lvl, rare, multiple)]}
    // affix["冰霜穿透"] = function (lvl, rare, multiple) {return ["pierce_frost+=" + get_effect_value(0.08, lvl, rare, multiple)]}
    affix["防寒"] = function (lvl, rare, multiple) {return ["res_frost+=" + get_effect_value(0.08, lvl, rare, multiple)]}
    ...
    affix["塑能"] = function (lvl, rare, multiple) {return ["damage_arcane+=" + get_effect_value(0.08, lvl, rare, multiple)]}
    // affix["奥术穿透"] = function (lvl, rare, multiple) {return ["pierce_arcane+=" + get_effect_value(0.08, lvl, rare, multiple)]}
    affix["抗魔"] = function (lvl, rare, multiple) {return ["res_arcane+=" + get_effect_value(0.08, lvl, rare, multiple)]}
    affix["神罚"] = function (lvl, rare, multiple) {return ["damage_holy+=" + get_effect_value(0.08, lvl, rare, multiple)]}
    // affix["神圣穿透"] = function (lvl, rare, multiple) {return ["pierce_holy+=" + get_effect_value(0.08, lvl, rare, multiple)]}
    affix["无神"] = function (lvl, rare, multiple) {return ["res_holy+=" + get_effect_value(0.08, lvl, rare, multiple)]}
