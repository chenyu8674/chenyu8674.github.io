...
function new_affix_prefix() {
    ...
    affix["巨人"] = function (lvl, rare, multiple) {return ["str+=" + get_effect_value(1, lvl, rare, multiple)]}
    affix["猫鼬"] = function (lvl, rare, multiple) {return ["agi+=" + get_effect_value(1, lvl, rare, multiple)]}
    affix["庞大"] = function (lvl, rare, multiple) {return ["sta+=" + get_effect_value(1, lvl, rare, multiple)]}
    affix["专注"] = function (lvl, rare, multiple) {return ["int+=" + get_effect_value(1, lvl, rare, multiple)]}
    affix["启发"] = function (lvl, rare, multiple) {return ["spr+=" + get_effect_value(1, lvl, rare, multiple)]}
