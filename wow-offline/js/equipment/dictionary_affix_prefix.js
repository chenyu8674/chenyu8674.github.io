...
function new_affix_prefix() {
    ...
    affix[6] = function(surely) {return surely || Math.random() <= 1 ? "野熊" : null};
    ...
    affix[7] = function(surely) {return surely || Math.random() <= 0.2 ? "巨猿" : null};
    ...
    affix[8] = function(surely) {return surely || Math.random() <= 0.2 ? "野猪" : null};
    ...
    affix[9] = function(surely) {return surely || Math.random() <= 1 ? "灵猴" : null};
    ...
    affix[10] = function(surely) {return surely || Math.random() <= 0.2 ? "猎鹰" : null};
    ...
    affix[11] = function(surely) {return surely || Math.random() <= 0.2 ? "孤狼" : null};
    ...
    affix[12] = function(surely) {return surely || Math.random() <= 0.8 ? "雄鹰" : null};
    ...
    affix[13] = function(surely) {return surely || Math.random() <= 0.8 ? "夜枭" : null};
    ...
    affix[14] = function(surely) {return surely || Math.random() <= 0.8 ? "巨鲸" : null};
