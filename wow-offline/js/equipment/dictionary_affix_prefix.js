...
function new_affix_prefix() {
    ...
    affix[7] = function(surely) {return surely || Math.random() <= 0.1 ? "巨猿" : null};
    ...
    affix[8] = function(surely) {return surely || Math.random() <= 0.1 ? "野猪" : null};
    ...
    affix[10] = function(surely) {return surely || Math.random() <= 0.1 ? "猎鹰" : null};
    ...
    affix[11] = function(surely) {return surely || Math.random() <= 0.1 ? "孤狼" : null};
    ...
    affix[12] = function(surely) {return surely || Math.random() <= 0.2 ? "雄鹰" : null};
    ...
    affix[13] = function(surely) {return surely || Math.random() <= 0.2 ? "夜枭" : null};
    ...
    affix[14] = function(surely) {return surely || Math.random() <= 0.2 ? "巨鲸" : null};
