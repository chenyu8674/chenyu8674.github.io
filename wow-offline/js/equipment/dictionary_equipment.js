...
function new_equipment() {
     ...
     */
    {
        ...
        equipment[33] = {
            name: "大佬衬衫", icon: "inv_shirt_01", rare: 6, affix: 6199, detail: "ONLY FOR SHIERBI",
            effect: ["speed_move+=400"]
        };
        equipment[34] = {
            name: "基情战袍", icon: "inv_shirt_guildtabard_01", rare: 6, affix: 7199, detail: "ONLY FOR SHIERBI",
    ...
    }// 测试装备
    {
        ...
        equipment[82879] = {
            ...
            effect: ["main+=3", "sta+=3", "dodge_rate+=2"]
        };
        equipment[82772] = {
        ...
        equipment[82880] = {
            ...
            effect: ["agi+=2", "sta+=3", "critical_rate+=1", "hit_rate+=1"]
        };
        equipment[151421] = {
            name: "焦灼的炽焰猎犬之靴", rare: 4, c_lvl: 13, e_lvl: 18, icon: "inv_boots_05", affix: 12102,
            effect: ["main+=4", "sta+=4", "critical_rate+=1", "dodge_rate+=2"]
        };
        equipment[151422] = {
        ...
        equipment[132552] = {
            ...
            effect: ["main+=3", "sta+=3", "critical_rate+=2"]
        };
        // 熔岩守卫戈多斯
        equipment[82888] = {
        ...
        equipment[82886] = {
            ...
            effect: ["main+=4", "sta+=4", "critical_rate+=3"]
        };
        equipment[82883] = {
        ...
        equipment[151424] = {
            ...
            effect: ["main+=4", "sta+=4", "hit_rate+=2", "dodge_rate+=1"]
        };
        equipment[151425] = {
            name: "戈多斯的碾压之手", rare: 4, c_lvl: 13, e_lvl: 18, icon: "inv_gauntlets_03", affix: 9103,
            effect: ["main+=4", "sta+=4", "hit_rate+=1", "dodge_rate+=2"]
        };
    }// 怒焰裂谷
    {
        // 黑暗迪菲亚
        ...
        equipment[5443] = {
            ...
            effect: ["main+=3", "sta+=3", "hit_rate+=2", "dodge_rate+=2"]
        };
        equipment[151062] = {
        ...
        equipment[1937] = {
            ...
            effect: ["agi+=2", "sta+=3", "critical_rate+=2", "hit_rate+=1"]
        };
        // 撕心狼将军
        equipment[5196] = {
            name: "重拳先生的战斧", rare: 4, c_lvl: 15, e_lvl: 20, icon: "inv_axe_01", affix: 15113,
            effect: ["str+=2", "sta+=3", "critical_rate+=2", "hit_rate+=1"]
        };
        equipment[872] = {
            name: "切石者", rare: 4, c_lvl: 15, e_lvl: 20, icon: "inv_throwingaxe_01", affix: 15123,
            effect: ["agi+=5", "sta+=8", "critical_rate+=5", "hit_rate+=3"]
        };
        equipment[1156] = {
        ...
        equipment[5197] = {
            ...
            effect: ["main+=2", "sta+=3", "critical_rate+=2", "dodge_rate+=1"]
        };
        equipment[5198] = {
        ...
        equipment[5192] = {
            ...
            effect: ["agi+=2", "sta+=3", "critical_rate+=1", "dodge_rate+=2"]
        };
        equipment[5193] = {
        ...
        equipment[63483] = {
            ...
            effect: ["main+=4", "sta+=4", "mastery_rate+=3", "dodge_rate+=2"]
        };
    ...
    }// 死亡矿井
    {
        equipment[10412] = {
            ...
            effect: ["main+=4", "sta+=4", "critical_rate+=3", "dodge_rate+=2"], sets: "毒蛇的拥抱"
        };// 安娜科德拉
        equipment[10411] = {
            name: "尖牙足垫", rare: 4, c_lvl: 16, e_lvl: 21, icon: "inv_boots_04", affix: 12102,
            effect: ["main+=4", "sta+=4", "hit_rate+=2", "dodge_rate+=3"], sets: "毒蛇的拥抱"
        };// 瑟芬迪斯
        equipment[10413] = {
        ...
        equipment[10410] = {
            ...
            effect: ["main+=6", "sta+=6", "critical_rate+=3", "hit_rate+=3"], sets: "毒蛇的拥抱"
        };// 考布莱恩
        equipment[6473] = {
            name: "尖牙铠甲", rare: 4, c_lvl: 16, e_lvl: 21, icon: "inv_shirt_16", affix: 4102,
            effect: ["main+=6", "sta+=6", "hit_rate+=3", "dodge_rate+=3"], sets: "毒蛇的拥抱"
        };// 皮萨斯
        // 安娜科德拉
        equipment[5404] = {
            name: "坚硬的肩垫", rare: 4, c_lvl: 16, e_lvl: 21, icon: "inv_shoulder_08", affix: 3102,
            effect: ["main+=4", "sta+=4", "critical_rate+=3", "hit_rate+=2"]
        };
        equipment[132737] = {
        ...
        equipment[151427] = {
            ...
            effect: ["main+=6", "sta+=6", "critical_rate+=3", "hit_rate+=3"]
        };
        equipment[151426] = {
        ...
        equipment[6460] = {
            ...
            effect: ["main+=4", "sta+=4", "hit_rate+=5"]
        };
        equipment[6465] = {
        ...
        equipment[6447] = {
            ...
            effect: ["main+=3", "sta+=3", "critical_rate+=1", "dodge_rate+=3"]
        };
        equipment[13245] = {
            name: "克雷什之背", rare: 4, c_lvl: 16, e_lvl: 21, icon: "inv_shield_18", affix: 16141,
            effect: ["main+=3", "sta+=3", "dodge_rate+=4"]
        };
        equipment[151430] = {
        ...
        equipment[6629] = {
            ...
            effect: ["main+=3", "sta+=3", "critical_rate+=2", "dodge_rate+=2"]
        };
        equipment[6630] = {
            name: "淡云圆盾", rare: 4, c_lvl: 16, e_lvl: 21, icon: "inv_shield_10", affix: 16141,
            effect: ["main+=3", "sta+=3", "critical_rate+=3", "dodge_rate+=1"]
        };
        equipment[6631] = {
        ...
        equipment[6627] = {
            ...
            effect: ["main+=6", "sta+=6", "critical_rate+=5", "dodge_rate+=1"]
        };
    }// 哀嚎洞穴
    /*
